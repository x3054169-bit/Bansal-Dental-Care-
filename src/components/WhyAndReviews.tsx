...
const reviews = [
  {
    text: "Very smooth and painless treatment with clear explanation. Doctor is polite and skilled.",
    author: "Satisfied Patient",
    rating: 5
  },
  {
    text: "Doctor Ashutosh is polite, skilled, and makes patients comfortable. Highly reliable.",
    author: "Jaipur Local",
    rating: 5
  },
  {
    text: "High-quality treatment at reasonable cost with excellent hygiene and modern equipment.",
...
const reasons = [
  "Experienced and skilled dentist",
          ...
          >
            ...
            >
               ...
               <div className="flex flex-col items-end relative z-10">
                  ...
                  <p className="text-xs font-black uppercase tracking-widest italic text-brand-accent">114+ Five-Star Reviews</p>
               </div>
            </motion.div>
          </motion.div>
