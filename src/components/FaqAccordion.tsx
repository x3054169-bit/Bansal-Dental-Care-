...
const faqs = [
  ...
  },
  {
    ...
    a: "Our standard hours are 10 AM to 2 PM, 5 PM to 9 PM (Mon-Sat) and 10 AM to 2 PM (Sun). However, for specific holiday hours or emergency appointments, we recommend giving us a quick call."
  }
];
    ...
    <section className="py-24 bg-brand-light">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mt-24 p-12 bg-white rounded-[40px] border border-gray-100 text-center shadow-sm">
           <h4 className="text-brand-secondary font-bold text-2xl mb-4 italic">Best Dental Clinic in Gopal Pura</h4>
           <p className="text-gray-500 max-w-2xl mx-auto leading-relaxed text-sm">
             Bansal Dental Care serves patients from across <strong>Gopal Pura</strong>, <strong>Arjun Nagar</strong>, and the wider <strong>Jaipur</strong> area. From professional consultations to painless treatments, we are recognized as a top-rated clinic (5.0 stars) for precision dental care in Rajasthan.
           </p>
        </div>
      </div>
    </section>
