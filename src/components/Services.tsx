...
const services = [
  {
    ...
    desc: "Safe and painless removal of damaged or problematic teeth using modern techniques.",
    icon: Activity,
    color: "bg-blue-50"
  },
  {
    title: "General Dentistry",
    desc: "Comprehensive routine checkups and care for patients of all ages.",
    icon: Stethoscope,
    color: "bg-green-50"
  },
  {
    title: "Painless Treatments",
    desc: "Experience stress-free dental care with our gentle clinical techniques and local anesthesia.",
    icon: Smile,
    color: "bg-pink-50"
  },
  {
    title: "Preventive Care",
    desc: "Proactive strategies and treatments to keep your smile healthy and avoid future issues.",
    icon: Sparkles,
    color: "bg-yellow-50"
  },
  {
    title: "Dental Procedures",
    desc: "Advanced clinical procedures using high-quality materials and modern equipment.",
    icon: Settings2,
    color: "bg-orange-50"
  }
];
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-20 gap-8">
          ...
          >
            <div className="inline-flex items-center gap-3 mb-6">
              ...
              <span className="text-[11px] font-black uppercase tracking-[0.4em] text-brand-accent">Gentle Excellence</span>
            </div>
            <h2 className="text-5xl md:text-7xl font-display font-black leading-tight tracking-tight">
              Gentle <br/>
              <span className="font-serif italic text-brand-accent font-light">Care Services</span>
            </h2>
          </motion.div>
          ...
          >
            "Providing professional, comfortable treatments in a hygienic environment. Your comfort is our top priority."
          </motion.p>
        </div>
