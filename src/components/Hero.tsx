        ...
        >
          ...
          <div className="space-y-4 mb-2">
            <div className="inline-flex items-center gap-4">
              ...
              <span className="text-[11px] font-black uppercase tracking-[0.45em] text-brand-accent uppercase">Gentle & Care Focused</span>
            </div>
          </div>
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-14 max-w-xl leading-relaxed font-serif italic border-l-2 border-brand-accent/50 pl-8">
            "Trusted by 100+ patients for painless and reliable treatment in Jaipur"
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 relative">
            ...
            <div className="absolute -top-7 left-0 flex items-center gap-1.5 drop-shadow-sm">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-brand-accent shadow-sm">Jaipur's Trusted Choice</span>
            </div>
          ...
          <div className="mt-16 grid grid-cols-3 gap-8">
             <div className="space-y-1">
                <p className="text-brand-accent font-black text-4xl">114+</p>
                <p className="text-[10px] uppercase font-bold text-white tracking-[0.2em] opacity-80">5-Star Reviews</p>
             </div>
             <div className="space-y-1">
                <p className="text-brand-accent font-black text-4xl">13y+</p>
                <p className="text-[10px] uppercase font-bold text-white tracking-[0.2em] opacity-80">Experience</p>
             </div>
             <div className="space-y-1">
                <p className="text-brand-accent font-black text-4xl">5.0</p>
                <p className="text-[10px] uppercase font-bold text-white tracking-[0.2em] opacity-80">Rating</p>
             </div>
          </div>
          ...
          <div className="mt-16 flex items-center gap-5">
            ...
            <div className="space-y-1">
              <p className="text-[11px] uppercase tracking-widest font-black text-brand-accent">Our Specialist</p>
              <p className="font-bold text-white italic text-lg drop-shadow-sm">Dr. Ashutosh Bansal</p>
            </div>
          </div>
        </motion.div>
